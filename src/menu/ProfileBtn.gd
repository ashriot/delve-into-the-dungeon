...
func init(game: Game, slot: int) -> void:
	self_modulate = Enums.default_color
	$Deletion/ColorRect.color = Enums.default_color
	slot_1.self_modulate = Enums.default_color
	slot_2.self_modulate = Enums.default_color
	slot_3.self_modulate = Enums.default_color
